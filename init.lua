...
require("lazy").setup({
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			vim.keymap.set("n", prefix .. "h", builtin.help_tags, { desc = "[S]earch [H]elp" })
			vim.keymap.set("n", prefix .. "k", builtin.keymaps, { desc = "[S]earch [K]eymaps" })
			vim.keymap.set("n", prefix .. "f", builtin.find_files, { desc = "[S]earch [F]iles" })
			vim.keymap.set("n", prefix .. "c", function()
				builtin.find_files({ cwd = vim.fn.stdpath("config") })
			end, { desc = "[F]ind [C]onfig" })
			vim.keymap.set("n", prefix .. "s", builtin.builtin, { desc = "[S]earch [S]elect Telescope" })
			vim.keymap.set("n", prefix .. "w", builtin.grep_string, { desc = "[S]earch current [W]ord" })
			vim.keymap.set("n", prefix .. "g", builtin.live_grep, { desc = "[S]earch by [G]rep" })
			vim.keymap.set("n", prefix .. "d", builtin.diagnostics, { desc = "[S]earch [D]iagnostics" })
			vim.keymap.set("n", prefix .. "r", builtin.resume, { desc = "[S]earch [R]esume" })
			vim.keymap.set("n", prefix .. ".", builtin.oldfiles, { desc = '[S]earch Recent Files ("." for repeat)' })
	...
	{ -- Autocompletion
		...
		config = function()
			...
			luasnip.config.set_config({
				...
				update_events = "TextChanged,TextChangedI", --show text in rep node as it is being written
				vim.cmd([[
